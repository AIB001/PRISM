...
def visualize_mapping_html(
    ...
    # NOTE: Skip 2D alignment for hybrid topologies - FindMCS can be very slow
    # and hybrid topologies already have reasonable 3D coordinates from the PDB
    # The 2D coordinates are already generated by Compute2DCoords in prepare_mol_with_charges_and_labels
    try:
        # Skip alignment for hybrid topologies (unusual valence states)
        # to avoid long MCS computation times
        # print(f"Note: Skipping 2D alignment for hybrid topology")
        # _align_mols_2d(mol_a, mol_b)
        pass  # Use default 2D coordinates from Compute2DCoords
