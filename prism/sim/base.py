...
from .utils import find_forcefield_dir
...
class SimulationModel:
    ...
    def __init__(self, gmx_dir):
        ...
        # Available engines
        self.engines = {"gmx": GMXSimulator, "gromacs": GMXSimulator, "openmm": OpenMMSimulator}
    ...
    def _validate_directory(self):
        ...
        if missing:
            raise FileNotFoundError(f"Missing required files in {self.gmx_dir}: {', '.join(missing)}")
